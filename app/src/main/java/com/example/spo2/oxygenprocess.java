...
public class oxygenprocess extends AppCompatActivity {
    ...
    private ProgressBar animation_view;
    private ProgressBar animation_view2;
    public int anim1 =0;
    public int anim2 =0;
    public int inc=0;
    ...
    private final Camera.PreviewCallback previewCallback = new Camera.PreviewCallback(){
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (RedAvg< 200){
                ...
                anim1=inc;
                anim2=inc;
                animation_view.setProgress(anim1);
                animation_view2.setProgress(anim2);
                processing.set(false);
            }

            long endTime =System.currentTimeMillis();
            double totalTimeInSecs = (endTime)/1000d;
